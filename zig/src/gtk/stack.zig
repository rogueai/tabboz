...
pub const Stack = struct {
    ...
    pub fn new() Self {
        return Self{
            .ptr = @as(*c.GtkStack, @ptrCast(c.gtk_stack_new())),
        };
    }
    ...
    pub fn set_visible_child_full(self: Self, name: [:0]const u8, transition: StackTransitionStyle) void {
        c.gtk_stack_set_visible_child_full(self.ptr, name.ptr, @intFromEnum(transition));
    }
    ...
    pub fn set_transition_type(self: Self, transition: StackTransitionStyle) void {
        c.gtk_stack_set_transition_type(self.ptr, @intFromEnum(transition));
    }

    pub fn get_transition_type(self: Self) StackTransitionStyle {
        return @as(StackTransitionStyle, @enumFromInt(c.gtk_stack_get_transition_type(self.ptr)));
    }
...
pub const StackSwitcher = struct {
    ...
    pub fn new() Self {
        return Self{ .ptr = @as(*c.GtkStackSwitcher, @ptrCast(c.gtk_stack_switcher_new())) };
    }
...
pub const StackSidebar = struct {
    ...
    pub fn new() Self {
        return Self{
            .ptr = @as(*c.GtkStackSidebar, @ptrCast(c.gtk_stack_sidebar_new())),
        };
    }
