...
pub const Label = struct {
    ...
    pub fn new(text: ?[:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkLabel, @ptrCast(c.gtk_label_new(if (text) |t| t.ptr else null))),
        };
    }
    ...
    pub fn set_justify(self: Self, justify: Justification) void {
        c.gtk_label_set_justify(self.ptr, @intFromEnum(justify));
    }
    ...
    pub fn set_ellipsize(self: Self, ellipsize: EllipsizeMode) void {
        c.gtk_label_set_ellipsize(self.ptr, @intFromEnum(ellipsize));
    }
    ...
    pub fn set_line_wrap_mode(self: Self, mode: WrapMode) void {
        c.gtk_label_set_line_wrap_mode(self.ptr, @intFromEnum(mode));
    }
    ...
    pub fn new_with_mnemonic(str: [:0]const u8) Self {
        return Self{ .ptr = @as(*c.GtkLabel, @ptrCast(c.gtk_label_new_with_mnemonic(str.ptr))) };
    }
    ...
    pub fn get_justify(self: Self) Justification {
        return @as(Justification, @enumFromInt(c.gtk_label_get_justify(self.ptr)));
    }
    ...
    pub fn get_ellipsize(self: Self) EllipsizeMode {
        return @as(EllipsizeMode, @enumFromInt(c.gtk_label_get_ellipsize(self.ptr)));
    }
    ...
    pub fn get_line_wrap_mode(self: Self) WrapMode {
        return @as(WrapMode, @enumFromInt(c.gtk_label_get_line_wrap_mode(self.ptr)));
    }
    ...
    pub fn to_accel_label(self: Self) ?AccelLabel {
        if (self.isa(AccelLabel)) {
            return AccelLabel{
                .ptr = @as(*c.GtkAccelLabel, @ptrCast(self.ptr)),
            };
        } else return null;
    }
};
...
pub const AccelLabel = struct {
    ...
    pub fn new(label: [:0]const u8) Self {
        return Self{ .ptr = @as(*c.GtkAccelLabel, @ptrCast(c.gtk_accel_label_new(label.ptr))) };
    }
    ...
    pub fn as_label(self: Self) Label {
        return Label{ .ptr = @as(*c.GtkLabel, @ptrCast(self.ptr)) };
    }
