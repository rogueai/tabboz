...
pub const Button = struct {
    ...
    pub fn new_with_label(text: [:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkButton, @ptrCast(c.gtk_button_new_with_label(text.ptr))),
        };
    }
    ...
    pub fn new_with_mnemonic(text: [:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkButton, @ptrCast(c.gtk_button_new_with_mnemonic(text.ptr))),
        };
    }
    ...
    pub fn new_from_icon_name(icon_name: [:0]const u8, size: IconSize) Self {
        return Self{
            .ptr = @as(*c.GtkButton, @ptrCast(c.gtk_button_new_from_icon_name(icon_name.ptr, @intFromEnum(size)))),
        };
    }
    ...
    pub fn set_relief(self: Self, style: ReliefStyle) void {
        c.gtk_button_set_relief(self.ptr, @intFromEnum(style));
    }
    ...
    pub fn set_image_position(self: Self, pos: PositionType) void {
        c.gtk_button_set_image_position(self.ptr, @intFromEnum(pos));
    }
...
pub const ToggleButton = struct {
    ...
    pub fn new() Self {
        return Self{
            .ptr = @as(*c.GtkToggleButton, @ptrCast(c.gtk_check_button_new())),
        };
    }
    ...
    pub fn new_with_label(text: [:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkToggleButton, @ptrCast(c.gtk_toggle_button_new_with_label(text.ptr))),
        };
    }
    ...
    pub fn new_with_mnemonic(text: [:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkToggleButton, @ptrCast(c.gtk_toggle_button_new_with_mnemonic(text.ptr))),
        };
    }
...
pub const CheckButton = struct {
    ...
    pub fn new_with_label(text: [:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkCheckButton, @ptrCast(c.gtk_check_button_new_with_label(text.ptr))),
        };
    }
    ...
    pub fn new_with_mnemonic(text: [:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkCheckButton, @ptrCast(c.gtk_check_button_new_with_mnemonic(text.ptr))),
        };
    }
