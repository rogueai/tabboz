...
pub const AppChooserButton = struct {
    ...
    pub fn new(content_type: [:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkAppChooserButton, @ptrCast(c.gtk_app_chooser_button_new(content_type.ptr))),
        };
    }
...
pub const AppChooserWidget = struct {
    ...
    pub fn new(content_type: [:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkAppChooserWidget, @ptrCast(c.gtk_app_chooser_widget_new(content_type.ptr))),
        };
    }
...
pub const AppChooserDialog = struct {
    ...
    pub fn new(parent: ?Window, flags: Dialog.Flags, file: c.GFile) Self {
        return Self{
            .ptr = @as(*c.GtkAppChooserDialog, @ptrCast(c.gtk_app_chooser_dialog_new(if (parent) |p| p else null, flags, file))),
        };
    }
    ...
    pub fn new_for_content_type(parent: ?Window, flags: Dialog.Flags, content: [:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkFileChooserDialog, @ptrCast(c.gtk_file_chooser_dialog_new_for_content_type(if (parent) |p| p else null, flags, content.ptr))),
        };
    }
    ...
    pub fn get_widget(self: Self) AppChooserWidget {
        return AppChooserWidget{
            .ptr = @as(*c.GtkAppChooserWidget, @ptrCast(c.gtk_app_chooser_dialog_get_widget(self.ptr))),
        };
    }
