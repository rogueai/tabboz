...
pub const Layout = struct {
    ...
    pub fn new(horizontal: Adjustment, vertical: Adjustment) Self {
        return Self{
            .ptr = @as(*c.GtkLayout, @ptrCast(c.gtk_layout_new(horizontal, vertical))),
        };
    }
    ...
    pub fn get_bin_window(self: Self) Window {
        return Window{
            .ptr = @as(*c.GtkWindow, @ptrCast(c.gtk_layout_get_bin_window(self.ptr))),
        };
    }
    ...
    pub fn as_scrollable(self: Self) Scrollable {
        return Scrollable{
            .ptr = @as(*c.GtkScrollable, @ptrCast(self.ptr)),
        };
    }
