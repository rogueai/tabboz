...
pub const Scrollable = struct {
    ...
    pub fn get_hscroll_policy(self: Self) Policy {
        return @as(Policy, @enumFromInt(c.gtk_scrollable_get_hscroll_policy(self.ptr)));
    }

    /// Sets the horizontal GtkScrollablePolicy.
    pub fn set_hscroll_policy(self: Self) Policy {
        return @as(Policy, @enumFromInt(c.gtk_scrollable_set_hscroll_policy(self.ptr)));
    }

    /// Gets the vertical GtkScrollablePolicy.
    pub fn get_vscroll_policy(self: Self) Policy {
        return @as(Policy, @enumFromInt(c.gtk_scrollable_get_vscroll_policy(self.ptr)));
    }

    /// Sets the vertical GtkScrollablePolicy.
    pub fn set_vscroll_policy(self: Self) Policy {
        return @as(Policy, @enumFromInt(c.gtk_scrollable_set_vscroll_policy(self.ptr)));
    }
