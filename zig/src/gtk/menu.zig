...
pub const Menu = struct {
    ...
    pub fn new() Self {
        return Self{
            .ptr = @as(*c.GtkMenu, @ptrCast(c.gtk_menu_new())),
        };
    }
...
pub const MenuItem = struct {
    ...
    pub fn new_with_label(text: [:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkMenuItem, @ptrCast(c.gtk_menu_item_new_with_label(text.ptr))),
        };
    }

    pub fn new_with_mnemonic(text: [:0]const u8) Self {
        return Self{
            .ptr = @as(*c.GtkMenuItem, @ptrCast(c.gtk_menu_item_new_with_mnemonic(text.ptr))),
        };
    }
