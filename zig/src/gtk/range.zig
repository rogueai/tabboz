...
pub const Range = struct {
    ...
    pub fn get_adjustment(self: Self) Adjustment {
        return Adjustment{
            .ptr = @as(*c.GtkAdjustment, @ptrCast(c.gtk_range_get_adjustment(self.ptr))),
        };
    }
    ...
    pub fn set_lower_stepper_sensitivity(self: Self, sensitivity: SensitivityType) void {
        c.gtk_range_set_lower_stepper_sensitivity(self.ptr, @intFromEnum(sensitivity));
    }

    pub fn get_lower_stepper_sensitivity(self: Self) SensitivityType {
        return @as(SensitivityType, @enumFromInt(c.gtk_range_get_lower_stepper_sensitivity(self.ptr)));
    }

    pub fn set_upper_stepper_sensitivity(self: Self, sensitivity: SensitivityType) void {
        c.gtk_range_set_upper_stepper_sensitivity(self.ptr, @intFromEnum(sensitivity));
    }

    pub fn get_upper_stepper_sensitivity(self: Self) SensitivityType {
        return @as(SensitivityType, @enumFromInt(c.gtk_range_get_upper_stepper_sensitivity(self.ptr)));
    }
...
pub const Scale = struct {
    ...
    pub fn new(orientation: Orientation, adjustment: Adjustment) Scale {
        return Scale{
            .ptr = @as(*c.GtkScale, @ptrCast(c.gtk_scale_new(@intFromEnum(orientation), adjustment.ptr))),
        };
    }

    pub fn new_with_range(orientation: Orientation, min: f64, max: f64, step: f64) Scale {
        return Scale{
            .ptr = @as(*c.GtkScale, @ptrCast(c.gtk_scale_new_with_range(@intFromEnum(orientation), min, max, step))),
        };
    }
    ...
    pub fn get_value_pos(self: Scale) PositionType {
        return @as(PositionType, @enumFromInt(c.gtk_scale_get_value_pos(self.scale)));
    }

    pub fn set_value_pos(self: Scale, pos: PositionType) void {
        c.gtk_scale_set_value_pos(self.ptr, @intFromEnum(pos));
    }

    pub fn add_mark(self: Scale, value: f64, pos: PositionType, markup: ?[:0]const u8) void {
        c.gtk_scale_add_mark(self.ptr, value, @intFromEnum(pos), if (markup) |t| t.ptr else null);
    }
...
pub const SpinButton = struct {
    ...
    pub fn new(adjustment: Adjustment, climb_rate: f64, digits: c_uint) Self {
        return Self{
            .ptr = @as(*c.GtkSpinButton, @ptrCast(c.gtk_spin_button_new(adjustment.ptr, climb_rate, digits))),
        };
    }
    ...
    pub fn set_update_policy(self: Self, policy: SpinButtonUpdatePolicy) void {
        c.gtk_spin_button_set_update_policy(self.ptr, @intFromEnum(policy));
    }
    ...
    pub fn spin(self: Self, direction: SpinType, increment: f64) void {
        c.gtk_spin_button_spin(self.ptr, @intFromEnum(direction), increment);
    }
    ...
    pub fn get_update_policy(self: Self) SpinButtonUpdatePolicy {
        return @as(SpinButtonUpdatePolicy, @enumFromInt(c.gtk_spin_button_get_update_policy(self.ptr)));
    }
