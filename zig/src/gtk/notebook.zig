...
pub const Notebook = struct {
    ...
    pub fn set_tab_pos(self: Notebook, pos: PositionType) void {
        c.gtk_notebook_set_tab_pos(self.ptr, @intFromEnum(pos));
    }
    ...
    pub fn get_tab_pos(self: Notebook) PositionType {
        return @as(PositionType, @enumFromInt(switch (c.gtk_notebook_get_tab_pos(self.ptr)) {
            c.GTK_POS_LEFT => .left,
    ...
    pub fn set_action_widget(self: Notebook, widget: Widget, packtype: PackType) void {
        c.gtk_notebook_set_action_widget(self.ptr, widget.ptr, @intFromEnum(packtype));
    }

    pub fn get_action_widget(self: Notebook, packtype: PackType) ?Widget {
        return if (c.gtk_notebook_get_action_widget(self.ptr, @intFromEnum(packtype))) |v| Widget{ .ptr = v } else null;
    }
